...
impl fmt::Display for CondaWasmError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::NotEmbedded(what) => write!(
                f,
                "no embedded {what} (build without CONDA_WASM_LOCKFILE_PATH / CONDA_WASM_PLATFORM)"
            ),
...
impl From<CondaWasmError> for JsValue {
    fn from(err: CondaWasmError) -> Self {
